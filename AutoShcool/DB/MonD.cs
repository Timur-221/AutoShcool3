...
namespace AutoShcool.DB
{
    public class MonD
    {
        ...
        public bool CheckDataExists(string username, string password)
        {
            ...
            var database = client.GetDatabase("AutoSchool"); // Замените "mydatabase" на имя вашей базы данных
            var collection = database.GetCollection<Account>("Admin"); // Замените "users" на имя вашей коллекции
        ...
        public void AddUser(UserInfo userInfo)
        {
            ...
            var client = new MongoClient(connectionString);
            var database = client.GetDatabase("AutoSchool"); // Замените "mydatabase" на имя вашей базы данных
            var collection = database.GetCollection<UserInfo>("Student"); // Замените "users" на имя вашей коллекции
